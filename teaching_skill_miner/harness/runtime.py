...
def _execute_call(
    ...
    *,
    ...
    def mark_effect_started() -> None:
        ...
        # The durable tool.started event precedes this checkpoint.  Persist the
        # fence before invoking the handler so a later provider call or process
        # recovery can never mistake this run for effect-free.
        _save_checkpoint(state, emitter, checkpoint_sink)
