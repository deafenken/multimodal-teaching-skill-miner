"""Stable, domain-neutral contracts for Agent Harness.

Product policy belongs in adapters above this layer. The core owns only
execution, tool, event, budget, authorization, and recovery contracts.
"""
...
HARNESS_SCHEMA = "agent_harness.run.v1"
HARNESS_EVENT_SCHEMA = "agent_harness.event.v1"
HARNESS_CHECKPOINT_SCHEMA = "agent_harness.checkpoint.v1"
HARNESS_MODEL_REQUEST_SCHEMA = "agent_harness.model_request.v1"
HARNESS_MODEL_RESPONSE_SCHEMA = "agent_harness.model_response.v1"
