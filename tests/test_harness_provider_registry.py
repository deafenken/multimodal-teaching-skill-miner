...
from teaching_skill_miner.harness import HarnessContractError, HarnessModelResponse
from teaching_skill_miner.harness.provider_registry import (
    ProviderErrorKind,
    ProviderFailure,
    ProviderModelSpec,
    ProviderRegistry,
...
from teaching_skill_miner.harness.providers import (
