...
from teaching_skill_miner.harness import HarnessCheckpoint
from teaching_skill_miner.harness.contracts import HarnessContractError
from teaching_skill_miner.harness.events import HarnessEventEmitter, canonical_sha256
from teaching_skill_miner.harness.journal import HarnessJournal
...
class HarnessSchemaTests(unittest.TestCase):
    ...
    def test_authoritative_event_and_checkpoint_match_public_schemas(self) -> None:
        ...
        checkpoint = HarnessCheckpoint.create(
            ...
            model_calls=0,
            tool_calls=0,
            context_sha256=canonical_sha256({"lesson": "schema"}),
